...
const SAMPLE_DATA = [
    {
        ...
        circumstances: "Last seen leaving work at approximately 6:30 PM. Vehicle found abandoned near highway.",
        gender: "Female",
    ...
    },
    {
        ...
        circumstances: "Failed to return from hiking trip in North Cascades National Park.",
        gender: "Male",
        race: "Asian",
        height: "5'9\"",
        weight: "165 lbs",
    ...
    },
    {
        ...
        cityLastSeen: "Austin",
        stateLastSeen: "Texas",
        circumstances: "Last seen at college campus library. Did not return to dormitory.",
        gender: "Female",
    ...
    },
    {
        ...
        circumstances: "Left home for daily walk and never returned. Has medical conditions requiring medication.",
        gender: "Male",
    ...
    },
    {
        ...
        circumstances: "Disappeared after leaving a friend's residence. Phone last pinged near downtown area.",
        gender: "Female",
        race: "Hispanic/Latino",
        height: "5'5\"",
        weight: "125 lbs",
    ...
    },
    {
        ...
        circumstances: "Failed to show up for work. Car found in workplace parking lot.",
        gender: "Male",
        race: "White/Caucasian",
        height: "5'11\"",
        weight: "195 lbs",
    ...
    },
    {
        ...
        circumstances: "Went missing after evening shift at restaurant. Last seen walking toward public transit station.",
        gender: "Female",
        race: "Asian",
        height: "5'3\"",
        weight: "115 lbs",
    ...
    },
    {
        ...
        circumstances: "Left for morning jog and never returned home. Phone and wallet found on jogging trail.",
        gender: "Male",
        race: "Hispanic/Latino",
        height: "5'10\"",
        weight: "175 lbs",
...
function setFeaturedCase() {
    ...
    document.getElementById('featuredName').textContent = `${featured.firstName} ${featured.lastName}`;
...
function applyFilters() {
    filteredData = SAMPLE_DATA.filter(person => {
        ...
        if (filters.ageRange) {
            ...
            if (filters.ageRange === '18-30' && (person.age < 18 || person.age > 30)) return false;
            if (filters.ageRange === '31-50' && (person.age < 31 || person.age > 50)) return false;
...
function updateView() {
    ...
    if (currentView === 'list') {
        ...
        document.getElementById('mapCount').textContent = `📍 ${filteredData.length} locations to display`;
    }
}
...
function showModal(person) {
    ...
    document.getElementById('modalLocation').textContent = `${person.cityLastSeen}, ${person.stateLastSeen}`;
    ...
    document.getElementById('modalPhysical').textContent = `${person.height}, ${person.weight}`;
    document.getElementById('modalCircumstances').textContent = person.circumstances;

    document.getElementById('shareButton').onclick = () => shareCase(person.id);
    document.getElementById('namusButton').onclick = () => {
        window.open(`https://namus.gov/MissingPersons/Case#/${person.id}`, '_blank');
    };
